...
<html>
    ...
    <body> 
        ...
        <%
            ...
            String sql = "Select name from pro.myproduct";
            ...
            <ul class="menu">
                <li class="item1"><a href="error.jsp"><%=map.get("electronic")%></a>
                    <ul class="cute">
                        ...
                        <li class="subitem2"><a href="controller?action=1">Laptop</a></li>
                        <li class="subitem3"><a href="controller?action=2"><%=map.get("phone")%></a></li>
                        <li class="subitem4"><a href="controller?action=3"><%=map.get("tv")%></a></li>
